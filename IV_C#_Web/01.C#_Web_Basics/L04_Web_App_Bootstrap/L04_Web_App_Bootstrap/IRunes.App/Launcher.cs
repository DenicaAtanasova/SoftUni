namespace IRunes.App
{
    ...
    public class Launcher
    {
        ...
        private static void Configure(ServerRoutingTable serverRoutingTable)
        {
            ...
            serverRoutingTable.Add(HttpRequestMethod.Post, "/Users/Login", request => new UsersController().DoLogin(request));
            serverRoutingTable.Add(HttpRequestMethod.Post, "/Users/Register", request => new UsersController().DoRegister(request));
            #endregion
            ...
            serverRoutingTable.Add(HttpRequestMethod.Post, "/Tracks/Create", request => new TracksController().DoCreate(request));
            #endregion
            ...
            serverRoutingTable.Add(HttpRequestMethod.Post, "/Albums/Create", request => new AlbumsController().DoCreate(request));
            #endregion
        }
    }
}